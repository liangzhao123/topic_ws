...
def parse_config():
    ...
    args.ckpt = "/media/liang/TOSHIBA EXT/src/PVRCNN-V1.1/ckpt/PVAnet/checkpoint_epoch_80.pth"
    args.pretrained_model = None

    args.ckpt_save_interval = 2
    args.max_ckpt_save_num = 40
    args.log_path = "/media/liang/TOSHIBA EXT/src/PVRCNN-V1.1/for_ros/models"
    args.eval_all = False
    args.start_epoch = 0
...
class PrepocessData:
    ...
    def get_calib(self):
        calib_file = os.path.join("/home/liang/kitti/testing/", 'calib', '000000.txt' )
