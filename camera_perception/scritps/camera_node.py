...
class image_listenner:
    def __init__(self,image_save_dir):
        ...
        self.image_sub = rospy.Subscriber("/pylon_camera_node/image_compressed",Image,self.image_sub_callback)
...
if __name__ == '__main__':
    ...
    # image_save_dir = "/media/liang/Elements/Five_Lidar_data/beike/2021-01-11-00-43-47/image"
    image_save_dir = "/media/liang/Elements/Five_Lidar_data/yijing/2021-01-10-12-06-18/image"
