...
if("TRUE" STREQUAL "TRUE")
  set(lane_SOURCE_PREFIX /home/liang/topic_ws/src/lane)
  set(lane_DEVEL_PREFIX /home/liang/topic_ws/devel)
  set(lane_INSTALL_PREFIX "")
  set(lane_PREFIX ${lane_DEVEL_PREFIX})
else()
  set(lane_SOURCE_PREFIX "")
  set(lane_DEVEL_PREFIX "")
  set(lane_INSTALL_PREFIX /home/liang/topic_ws/install)
...
if(NOT "/usr/include/pcl-1.8;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lane' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/liang/topic_ws/src/lane/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT lane_NUM_DUMMY_TARGETS)
      set(lane_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::lane::wrapped-linker-option${lane_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR lane_NUM_DUMMY_TARGETS "${lane_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::lane::wrapped-linker-option${lane_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND lane_LIBRARIES "${interface_target_name}")
